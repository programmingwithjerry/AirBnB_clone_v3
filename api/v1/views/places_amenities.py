#!/usr/bin/python3
"""Handles standard RestFul API operations for linking Places and Amenities"""
...
def get_place_amenities(place_id):
    """
    Retrieves all Amenity objects associated with a specified Place
    """
...
def post_place_amenity(place_id, amenity_id):
    """
    Associates an Amenity with a specific Place
    """
    place = storage.get(Place, place_id)
