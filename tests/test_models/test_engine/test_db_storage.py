...
class TestDBStorage(unittest.TestCase):
    ...
    def test_get(self):
        ...
        new_state.save()
        new_user = User(email="yellow@foobar.com", password="password")
        new_user.save()
        self.assertIs(new_state, models.storage.get("State", new_state.id))
        self.assertIs(None, models.storage.get("State", "fake"))
        self.assertIs(None, models.storage.get("fake", "fake"))
    ...
    def test_count(self):
        ...
        self.assertEqual(models.storage.count("Fake"), 0)
